...
1. Explain the difference between `RDBMS` and `SQL`.
    A relational database management system (RDBMS) stores data in a structured format, using rowa and columns.  SQL is used to communicatewith the database and performs tasks such as updating or retrieving data.

----------------------------------------------------------------------

2. Why do tables need a `primary key`?
    A primary key is used to uniquely identy a row in a table.
...
4. What do we need in order to have a _many to many_ relationship between two tables.
    You need a 'join' table to establish a relationship between the other two tables.
